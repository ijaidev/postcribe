...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
    return (
        <motion.div
            ...
            className={cn(
                "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-lg bg-transparent px-6 py-2 lg:flex dark:bg-transparent",
...
export const NavbarLogo = () => {
    return (
        <a
            href="#"
            className="font-norma relative z-20 mr-4 flex h-[40px] items-center space-x-2 overflow-hidden px-2 py-1 text-sm"
        >
            <Image
