...
export default function SettingsPage() {
    ...
    const hasProfileChanged =
        ...
        watchedValues.timeZone !== (user?.timeZone || "");
    ...
    const handleLinkGoogle = async () => {
        try {
            ...
            if (res.error || !res.data) {
                toast.error(
                    res.error?.message || "Failed to link Google account",
                );
            }
        } catch (err: unknown) {
            const errorMessage =
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription className="text-sm">
                                            Manage your connected social media
                                            accounts
                                        </CardDescription>
                                    </div>
                                </div>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {accountToUnlink?.provider === "credential"
                                ? "email"
                                : accountToUnlink?.provider}{" "}
                            account? This action cannot be undone and you may
